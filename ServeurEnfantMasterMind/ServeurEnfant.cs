            ...
            try {
                ...
                while (true) {
                    ...
                    while (true) {
                        ...
                        // Se préparer à faire la logique des pions noirs et des pions blancs
                        ...
                        // Calcul des points
                        if (blackPinCount > 0) {
                            int points = blackPinCount + offset;
                        ...
                        // Envoyer au client
                        if (winner) { // Si le joueur à gagné
                            Envoyer(solution);
                            Envoyer(feedBack);
                        }
                        else {
                            if (guess.CurrentRow == 10) { // Si le joueur a perdu
                                feedBack.Argent = 0.0;
                                Envoyer(solution);
                            }
