...
namespace ClientMasterMind {
    public partial class Form1: Form {
        ...
        private int currentRow; // Rangée actuelle (de 1 à 10)
        ...
        private void btnChangeSettings_Click(object sender, EventArgs e) {
            ...
            // Activer les contrôles des paramètres
        ...
        private void btnPlay_Click(object sender, EventArgs e) {
            ...
            // Désactiver les contrôles des paramètres
            ...
            // Activer les bouton de couleurs (Ils sont désactivés quand le joueur gagne avant le dernier essaie)
            EnableColors();

            // Activer les contrôles du jeu
        ...
        private void btnValidate_Click(object sender, EventArgs e) {
            ...
            colorPacket.CurrentRow = currentRow; // Spécifier la rangée actuelle pour l'objet colorPacket
        ...
        private void ResetGame(bool sendSettings) {
            ...
            if (sendSettings) {
                ...
                // Activé les boutons de couleurs (Ils sont désactivés quand le joueur gagne avant le dernier essaie)
                EnableColors();
            }
            ...
            while (currentRow > 0) {
                // Réinitialiser la rangée actuelle
                while (guessPosition > 1) {
                    guessPosition--;
                    ChangerCouleur(Color.LightGray);
                }

                // Réinitialiser le feedback de la rangée actuelle
                for (int i = 1; i < 5; i++)
            ...
            // Désactiver le bouton valider et activé les boutons pour effacer
            btnValidate.Enabled = false;
            btnDelete1.Enabled = true;
            btnDeleteRow.Enabled = true;
        ...
        private void btnResetGame_Click(object sender, EventArgs e) {
            // Réinitialiser le jeu, envoyer les paramètres au serveur et activer les boutons de couleurs
            ResetGame(true);
        }
        ...
        private void AjouterCouleur(Color color) {
            if (guessPosition < 5) { // On ne peut pas ajouter une couleur si la rangée est déjà complétée
                ...
                colorPacket.Couleurs[guessPosition - 1] = color; // Gérer le ColorPacket
                guessPosition++;
